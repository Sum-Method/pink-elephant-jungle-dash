...
const TRANSITIONS = Object.freeze({
  ...
  [GAME_STATES.TITLE]: [GAME_STATES.FIRST_RUN, GAME_STATES.LEVEL_INTRO, GAME_STATES.SETTINGS, GAME_STATES.CREDITS, GAME_STATES.ERROR],
  [GAME_STATES.FIRST_RUN]: [GAME_STATES.LEVEL_INTRO, GAME_STATES.TITLE, GAME_STATES.SETTINGS],
  [GAME_STATES.LEVEL_INTRO]: [GAME_STATES.PLAYING, GAME_STATES.SETTINGS, GAME_STATES.TITLE],
  ...
  [GAME_STATES.PAUSED]: [GAME_STATES.PLAYING, GAME_STATES.SETTINGS, GAME_STATES.TITLE, GAME_STATES.ERROR],
  [GAME_STATES.SETTINGS]: [GAME_STATES.TITLE, GAME_STATES.PAUSED, GAME_STATES.PLAYING, GAME_STATES.CREDITS],
  [GAME_STATES.LEVEL_COMPLETE]: [GAME_STATES.LEVEL_INTRO, GAME_STATES.CREDITS, GAME_STATES.TITLE],
  [GAME_STATES.GAME_OVER]: [GAME_STATES.LEVEL_INTRO, GAME_STATES.SETTINGS, GAME_STATES.TITLE],
  [GAME_STATES.CREDITS]: [GAME_STATES.TITLE, GAME_STATES.PAUSED, GAME_STATES.SETTINGS],
